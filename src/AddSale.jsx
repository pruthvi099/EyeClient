...
const AddSale = () => {
  ...
  useEffect(() => {
    axios.get('https://eyeserver-woad.vercel.app/shalacustomers')
      .then(response => {
    ...
    axios.get('https://eyeserver-woad.vercel.app/shalaproducts')
      .then(response => {
  ...
  const handleCustomerChange = async (event) => {
    ...
    setCustomerId(id);
    try {
      const response = await axios.get(`https://eyeserver-woad.vercel.app/shalacustomers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://eyeserver-woad.vercel.app/shalaproducts/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://eyeserver-woad.vercel.app/shalasales', {
