...
const EditProduct = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://eyeserver-woad.vercel.app/apiproducts/${id}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`https://eyeserver-woad.vercel.app/apiproducts/${id}`, productData);
