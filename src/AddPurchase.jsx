...
const AddPurchase = () => {
  ...
  useEffect(() => {
    axios.get('https://eyeserver-woad.vercel.app/followsuppliers')
      .then(response => {
    ...
    axios.get('https://eyeserver-woad.vercel.app/followproducts')
      .then(response => {
  ...
  const handleSupplierChange = async (event) => {
    ...
    setSupplierId(id);
    try {
      const response = await axios.get(`https://eyeserver-woad.vercel.app/followsuppliers/${id}`);
  ...
  const handleProductChange = async (index, event) => {
    ...
    try {
      const response = await axios.get(`https://eyeserver-woad.vercel.app/followproducts/${id}`);
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('https://eyeserver-woad.vercel.app/followpurchases', {
