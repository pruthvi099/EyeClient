...
const PurchaseList = () => {
  ...
  const fetchPurchases = async () => {
    try {
      const response = await axios.get('https://eyeserver-woad.vercel.app/walashalapurchases');
  ...
  const fetchPurchaseById = async (id) => {
    try {
      const response = await axios.get(`https://eyeserver-woad.vercel.app/walashalapurchases/${id}`);
